...
const ViewHeader: React.FC<ViewHeaderProps> = ({ currentViewLabel, onPrev, onNext, isFirstView, isLastView }) => {
  ...
  return (
    <header className="p-3 text-center bg-neutral-100 border-b border-neutral-200 sticky top-0 z-10">
      <div className="flex items-center justify-between max-w-md mx-auto">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-xl font-semibold text-neutral-800 capitalize">{viewDisplayNames[currentViewLabel]}</h1>
